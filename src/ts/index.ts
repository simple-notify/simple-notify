...
export default class Notify {
  ...
  constructor (args:IArgs) {
    ...
    // init autoremove
    if(this.autoremove) this.autoRemove()
  ...
  private setObserver():void {
    ...
    setTimeout(() => {observer.observe(this.wrapper)}, this.speed)
  }

  private notifyIn(callback: Function): void {
    callback(this)
  }

  private notifyOut = (callback: Function): void => {
    callback(this)
  }

  private autoRemove():void {
    setTimeout(() => {this.close()}, this.autotimeout + this.speed)
  }
