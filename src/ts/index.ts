...
export default class Notify {
  ...
  effect: notify.notifyEffect
  position: notify.notifyPosition
  title: string
  text: string
  showIcon: boolean
  customIcon: string
